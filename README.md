...
<details> <summary>Explaining "The Best Tier"</summary>
  <details> <summary>Fedora</summary>
    Sistema estavel com updates fixos porem ao mesmo tempo muito Bleeding Edge, que tende a testar muitas tecnologias novas, 
    com uma base de usuarios gigantesca reportando qualquer bug, gerando uma experiencia bem estavel sem maiores problemas, 
    uma distro feito para iniciante/intermediario no mundo do linux, geralmente com opinios fortes porem que nao afetam tanto o usuario
  ...
  <details> <summary>Arch</summary>
    Sistema totalmente Bleeding Edge, sempre muito atualizado e sempre muito libertador com qualquer mudanca que o usuario queira fazer, com uma base de pacotes e usuarios gigantesca elimando bastante bugs, porem e considerado um sistema extremamente fragil
  ...
  <details> <summary>Debian</summary>
    Sistema Totalmente focado em Estabilidade, sempre com os pacotes mais testados possiveis, com meses ou ate anos de teste para verificar e garantir sempre a experiencia mais correta e estavel possivel, totalmente segura de bugs, 
